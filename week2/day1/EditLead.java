...
public class EditLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Sathiyanarayanan");
		...
		driver.findElement(By.id("updateLeadForm_importantNote")).sendKeys("Edit functionality is working");
		driver.findElement(By.name("submitButton")).click();
